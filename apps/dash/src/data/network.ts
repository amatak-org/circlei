import { capFirst, NetworkInfo, NetworkLoad, removePad } from '@panel/common';
  ...
  speedTest: async (printResult = false): Promise<Partial<NetworkInfo>> => {
    ...
    if (CONFIG.speed_test_from_path) {
      ...
      throw new Error(removePad`
        ...
        For more help on how to setup Amatak Panel, look here:
        https://github.com/amatak-org/server
      `);
    }
