import { Config } from '@panel/common';
...
const penv = (key: string): string | undefined => process.env[`AMATAK_PANEL_${key}`];
...
export const CONFIG: Config = {
  ...
  show_panel_version: penv('SHOW_PANEL_VERSION') as any,
  show_host: penv('SHOW_HOST') === 'true',
  custom_host: penv('CUSTOM_HOST'),
  page_title: penv('PAGE_TITLE') ?? 'Amatak Panel',
